package com.example.arun.hirjigregoriancalendar.Customcalender.calendar;
...
import com.example.arun.hirjigregoriancalendar.Customcalender.MyCalendarView;
import static com.example.arun.hirjigregoriancalendar.Customcalender.MyCalendarView.Language.Arabic;


public class MyCustomCalendar extends GregorianCalendar {
    ...
    public MyCustomCalendar(Locale aLocale) {
        this(TimeZone.getDefault(), aLocale);
    }

    public MyCustomCalendar(TimeZone zone, Locale aLocale) {
        super(zone, aLocale);
    }

    public MyCustomCalendar(int year, int month, int dayOfMonth) {
        this(year, month, dayOfMonth, 0, 0, 0);
    }

    public MyCustomCalendar(int year, int month, int dayOfMonth, int hourOfDay,
                            int minute) {
...
//        set(SECOND, second);
    ...
    public int getCalDay(int field){
        int[] arrcaldata = null;
        try {
            Calendar calendar = Calendar.getInstance();
            if (MyCalendarView.language == Arabic.getLanguageValue()) {
                arrcaldata  = MyCustomCalendar.UmmalquraGregorianConverter.toHijri(calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DATE));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }

        if(arrcaldata != null && arrcaldata[2] > 0){
            return arrcaldata[2];
        }
    ...
    public boolean equals(Object obj) {
        return obj instanceof MyCustomCalendar && super.equals(obj);
    }
...
//    }
        ...
        private void initializeData(Locale desiredLocale) {
            ...
            ResourceBundle resource = ResourceBundle.getBundle("com.example.arun.hirjiGregorialcalendar.UmmalquraFormatData",locale);
    ...
    public static class UmmalquraGregorianConverter {
        ...
        public static int[] toHijri(Date date) {
            ...
            int[] hDateInfo = d2h(g2d(gCal.get(Calendar.YEAR),
        ...
        private static int[] ummalquraData = {28607, 28636, 28665, 28695, 28724, 28754, 28783, 28813, 28843, 28872, 28901, 28931, 28960, 28990, 29019, 29049, 29078, 29108, 29137, 29167,
